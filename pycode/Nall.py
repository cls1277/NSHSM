                    ...
                    if L < R:
                        ...
                        for pos in range(R, L):  # from R to L-1
                            ...
                            if PJ_index[index_v] == -1:
                                ...
                                st = max(end_time_index[PJ_index[index_v]], end_time_index[index_pos]) - end_time_index[
                                    index_pos]
                            if PJ_index[index_pre] == -1:
                                et = 0
                            else:
                                et = max(end_time_index[index_pos] + st + time_v,
                                         end_time_index[PJ_index[index_pre]]) - (
                                                 end_time_index[index_pos] + st + time_v)
                        ...
                        if PJ_index[index_v] == -1:
                            ...
                            st = max(end_time_index[PJ_index[index_v]], end_time_index[index_l]) - end_time_index[
                                index_l]
